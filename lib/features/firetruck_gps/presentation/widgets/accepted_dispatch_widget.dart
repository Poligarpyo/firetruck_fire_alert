...
import 'incident_photo_capture_card.dart';
import '../screen/complete_response_screen.dart';

class AcceptedDispatchWidget extends ConsumerWidget {
  const AcceptedDispatchWidget({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final isOnScene = incidentHasArrived(dispatch.incidentData);
    final compactPhoto = MediaQuery.sizeOf(context).height < 720;
                    ...
                    child: Column(
                      ...
                      children: [
                              ...
                              Expanded(
                                child: Text(
                                  ...
                                  style: context.responsiveBodyText(
                                    ...
                                    fontSizeLarge: AppTheme.fontSize13,
                                    fontSizeExtraLarge: AppTheme.fontSize14,
                        ...
                        IncidentPhotoCaptureCard(
                          ...
                          incidentData: dispatch.incidentData,
                ...
                Consumer(
                  builder: (context, ref, child) {
                    ...
                    return statusAsync.when(
                      ...
                      error: (_, __) => SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Icon(Icons.task_alt, size: AppTheme.iconSize20),
                              SizedBox(width: AppTheme.spacing8),
                              Text(
                                'Complete Response',
                                style: AppTheme.buttonMedium.copyWith(
                      ...
                      data: (status) {
                        final canComplete = status.hasBefore;
                        return SizedBox(
                          width: double.infinity,
                          child: ElevatedButton(
