...
mixin _$LoginCredentials {
 ...
 String get firetruckCode; String get firetruckName;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoginCredentials&&(identical(other.firetruckCode, firetruckCode) || other.firetruckCode == firetruckCode)&&(identical(other.firetruckName, firetruckName) || other.firetruckName == firetruckName));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,firetruckCode,firetruckName);

@override
String toString() {
  return 'LoginCredentials(firetruckCode: $firetruckCode, firetruckName: $firetruckName)';
}
...
@useResult
$Res call({
 String firetruckCode, String firetruckName
});
...
/// Create a copy of LoginCredentials
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? firetruckCode = null,Object? firetruckName = null,}) {
  return _then(_self.copyWith(
firetruckCode: null == firetruckCode ? _self.firetruckCode : firetruckCode // ignore: cast_nullable_to_non_nullable
as String,firetruckName: null == firetruckName ? _self.firetruckName : firetruckName // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String firetruckCode,  String firetruckName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginCredentials() when $default != null:
return $default(_that.firetruckCode,_that.firetruckName);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String firetruckCode,  String firetruckName)  $default,) {final _that = this;
switch (_that) {
case _LoginCredentials():
return $default(_that.firetruckCode,_that.firetruckName);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String firetruckCode,  String firetruckName)?  $default,) {final _that = this;
switch (_that) {
case _LoginCredentials() when $default != null:
return $default(_that.firetruckCode,_that.firetruckName);case _:
  return null;
...
class _LoginCredentials implements LoginCredentials {
  const _LoginCredentials({required this.firetruckCode, required this.firetruckName});
  factory _LoginCredentials.fromJson(Map<String, dynamic> json) => _$LoginCredentialsFromJson(json);

@override final  String firetruckCode;
@override final  String firetruckName;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LoginCredentials&&(identical(other.firetruckCode, firetruckCode) || other.firetruckCode == firetruckCode)&&(identical(other.firetruckName, firetruckName) || other.firetruckName == firetruckName));
}
...
/// Create a copy of LoginCredentials
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? firetruckCode = null,Object? firetruckName = null,}) {
